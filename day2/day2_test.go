...
import (
	...
	"github.com/merkata/go-aoc-2021/day2"
)
...
func TestCalculateCoordinates(t *testing.T) {
	...
	for _, tc := range tests {
		...
		got := day2.CalculateCoordinates(&submarine, tc.input)
		if tc.want != got {
...
func TestCalculateCoordinatesSophisticated(t *testing.T) {
	tests := []test{
	...
	for _, tc := range tests {
		submarine := day2.SophisticatedSubmarine{}
		got := day2.CalculateCoordinates(&submarine, tc.input)
		if tc.want != got {
			t.Errorf("failed test: %s, wanted %d got %d\n", tc.description, tc.want, got)
		}
